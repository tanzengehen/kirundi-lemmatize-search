...
```
cd existing_repo
git remote add origin https://gitlab.com/kirundi-analysis/find_lemmata_in_corpus.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/kirundi-analysis/find_lemmata_in_corpus/-/settings/integrations)
...
## Installation
Kirundi-NLP needs a GUI. Till now it's only running in terminal-mode.
It's written in Python3 
Dependencies: nltk, unidecode, json, re, operator, sys
